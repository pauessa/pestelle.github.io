    ...
    all.forEach(function (row) {
        table.columns.forEach(function (col) {
            ...
            if (cell.styles.overflow === 'linebreak') {
                ...
                console.info("Unrecognized overflow type: " + cell.styles.overflow);
            }
            var k = config_1.Config.scaleFactor();
...
function validateInput(headers, data, allOptions) {
    if (!headers || typeof headers !== 'object') {
        console.info("The headers should be an object or array, is: " + typeof headers);
    }
    if (!data || typeof data !== 'object') {
        console.info("The data should be an object or array, is: " + typeof data);
    }
    var _loop_1 = function (settings) {
        if (settings && typeof settings !== 'object') {
            console.info("The options parameter should be of type object, is: " + typeof settings);
        }
        if (typeof settings.extendWidth !== 'undefined') {
            settings.tableWidth = settings.extendWidth ? 'auto' : 'wrap';
            console.info("Use of deprecated option: extendWidth, use tableWidth instead.");
        }
        if (typeof settings.margins !== 'undefined') {
            if (typeof settings.margin === 'undefined')
                settings.margin = settings.margins;
            console.info("Use of deprecated option: margins, use margin instead.");
        }
        if (typeof settings.afterPageContent !== 'undefined' || typeof settings.beforePageContent !== 'undefined' || typeof settings.afterPageAdd !== 'undefined') {
            console.info("The afterPageContent, beforePageContent and afterPageAdd hooks are deprecated. Use addPageContent instead");
        ...
        [['padding', 'cellPadding'], ['lineHeight', 'rowHeight'], 'fontSize', 'overflow'].forEach(function (o) {
            ...
            if (typeof settings[deprecatedOption] !== 'undefined') {
                ...
                console.info("Use of deprecated option: " + deprecatedOption + ", use the style " + style + " instead.");
            }
        });
        for (var _i = 0, _a = ['styles', 'bodyStyles', 'headerStyles', 'columnStyles']; _i < _a.length; _i++) {
            ...
            if (settings[styleProp] && typeof settings[styleProp] !== 'object') {
                console.info("The " + styleProp + " style should be of type object, is: " + typeof settings[styleProp]);
            }
            else if (settings[styleProp] && settings[styleProp].rowHeight) {
                console.info("Use of deprecated style: rowHeight, use vertical cell padding instead");
            }
        }
    };
...
function createModels(inputHeaders, inputData) {
    ...
    inputHeaders.forEach(function (rawColumn, index) {
        ...
        if (typeof rawColumn.dataKey !== 'undefined') {
            ...
            console.info("Deprecation warning: Use dataKey instead of key");
...
jsPDF.API.autoTableHtmlToJson = function (tableElem, includeHiddenElements) {
    ...
    if (!tableElem || !(tableElem instanceof HTMLTableElement)) {
        console.info("A HTMLTableElement has to be sent to autoTableHtmlToJson");
        return null;
    }
    var columns = {}, rows = [];
...
jsPDF.API.autoTableText = function (text, x, y, styles) {
    if (typeof x !== 'number' || typeof y !== 'number') {
        console.info('The x and y parameters are required. Missing for the text: ', text);
    }
